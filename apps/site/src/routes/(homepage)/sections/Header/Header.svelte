...
<div class="my-6 space-x flex flex-col">
	...
	<div class="flex flex-col items-center md:flex-row md:items-start md:gap-x-6">
		<img
			...
			width="320"
			height="240"
			class="mb-2 block h-auto w-3.5/5 rounded-lg object-cover shadow-lg"
		/>
		<div
			class="h-full flex flex-col items-center justify-end text-center md:ml-4 md:items-start md:text-left"
		>
			<!-- A bit of empty space -->
			<div class="h-50"></div>
			<p class="text-center type-label text">Check out these links to explore our club!</p>
			<ul class="grid grid-cols-2 list-none gap-2 sm:gap-2">
				<ListItem
					Icon={FlaskConical}
