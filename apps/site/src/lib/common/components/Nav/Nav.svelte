...
<nav class="relative space-x w-full flex items-center justify-between py-3">
	<a href={resolve('/')} class="flex shrink-0 items-center gap-2 py-2 text decoration-none">
	...
	<div class="block shrink-0 lg:hidden"><Small /></div>
</nav>
